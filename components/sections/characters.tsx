  ...
  return (
    <section className="characters">
      ...
      <div className="relative bg-[#dd0403]">
        ...
        <div className="xl:absolute lg:left-[8%] lg:top-1/2 lg:transform mx-[10px] sm:mx-auto lg:mx-0 mt-[30px] lg:mt-0 lg:-translate-y-1/2 max-w-[562px] py-[110px] md:py-[160px] px-[40px] lg:py-[94px] lg:px-[82px] bg-[url('/character-bg-card.png')] bg-center bg-no-repeat bg-cover">
        ...
        <div className="lg:absolute top-1/2 xl:top-1/4 right-1/6 mx-auto mt-24 lg:mt-0 lg:mx-0 w-fit lg:w-auto">
